    ...
    private void PerformAuth() {
        ...
        if (email.isEmpty()) {
            ...
            return;
                ...
                Toast.makeText(driverreg.this, "field is required", Toast.LENGTH_SHORT).show();
                MobileNumber1.setError(" Mobile Number is required");
                MobileNumber1.requestFocus();
            } else if (phoneNumber.length()!=10) {
                Toast.makeText(driverreg.this, "Re-enter mobile number", Toast.LENGTH_SHORT).show();
                MobileNumber1.setError(" 10 digit required");
                MobileNumber1.requestFocus();
            }else if (!mobileMatcher.find()) {
            Toast.makeText(driverreg.this, "Re-enter mobile number", Toast.LENGTH_SHORT).show();
            MobileNumber1.setError("mobile number is not valid");
            MobileNumber1.requestFocus();
            ...
            Toast.makeText(driverreg.this, "field is required", Toast.LENGTH_SHORT).show();
            Address1.setError(" adharno is required");
            Address1.requestFocus();
        }else if (adharno.length()!=12) {
            Toast.makeText(driverreg.this, "Re-enter mobile number", Toast.LENGTH_SHORT).show();
            Adharno1.setError(" 12 digit required");
            Adharno1.requestFocus();
        } else if (TextUtils.isEmpty(area)) {
            Toast.makeText(driverreg.this, "field is required", Toast.LENGTH_SHORT).show();
            Area1.setError(" address is required");
            Area1.requestFocus();
        } else {
