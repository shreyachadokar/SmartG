...
public class driverlogin extends AppCompatActivity {
    ...
    Button buttonsign, forgot_password;
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgot_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(driverlogin.this, "You can reset your password now!", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(driverlogin.this,ForgotPasswordActivity.class));
            }
        });
